...
import { StyleSheet, Text, View, TouchableOpacity, Image, ScrollView, TouchableHighlight,Picker, Modal } from 'react-native'
...
<View style={styles.smallContainer}>
            ...
            <TouchableOpacity onPress={() => {this.setModalVisible(true);}}>
                <Image source={{uri: 'https://www.ikea.com/PIAimages/0243994_PE383246_S5.JPG'}} style={{height: 100 , width: 'auto'}} />
              </TouchableOpacity>
